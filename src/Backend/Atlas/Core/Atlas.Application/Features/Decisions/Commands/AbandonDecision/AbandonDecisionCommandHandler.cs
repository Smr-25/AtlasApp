...
public class AbandonDecisionCommandHandler(
    IApplicationDbContext applicationDbContext,
    ICurrentUserService currentUserService,
    IMapper mapper) : IRequestHandler<AbandonDecisionCommand, ResponseModel<DecisionDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        decision.Abandon(request.Reason);
