...
export const integrationProviders: IntegrationProviderInfo[] = [
  ...
  // Communication
  { provider: "Slack", name: "Slack", description: "Team messaging & notifications", icon: "💬", category: "Communication", roles: ["developer", "designer", "cybersecurity", "team-leader"] },
  { provider: "Discord", name: "Discord", description: "Community & voice chat", icon: "🎮", category: "Communication", roles: ["developer", "designer", "cybersecurity", "team-leader"] },
  ...
  { provider: "Perplexity", name: "Perplexity", description: "AI-powered research", icon: "🤖", category: "AI", roles: ["developer", "designer", "cybersecurity", "team-leader"] },
